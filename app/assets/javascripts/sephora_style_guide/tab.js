...
var Tab = function ($) {
  ...
  var Tab = function () {
    ...
    Tab.prototype.show = function show() {
      ...
      this._moveBar($(this._element).parent(), $(listElement));
    ...
    Tab.prototype._getLeftMargin = function _getLeftMargin($tbs, index) {
      var totalMargin = 0;
    ...
    Tab.prototype._moveBar = function _moveBar($selectedTab, $ul) {
      var $lis = $ul.find('li'),
